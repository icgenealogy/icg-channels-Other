TITLE simple GABA receptors

COMMENT
This is modified from the AMPA receptor provided by Neuron. The only
difference is some parameter values.
...
PARAMETER {
	...
	Beta	= 0.1	(/ms)		: backward (unbinding) rate
